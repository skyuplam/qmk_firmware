// Copyright 2025 Terrence Lam (@skyuplam) <skyuplam@gmail.com>
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [U_BASE] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_ALPH,      UC_ALPH,      UC_ALPH,     UC_ALPH,     UC_ALPH,
        UC_OFF,       UC_HMOD,      UC_HMOD,      UC_HMOD,     UC_HMOD,     UC_ALPH,
        UC_OFF,       UC_LT,        UC_ALPH,      UC_ALPH,     UC_ALPH,     UC_ALPH,
        UC_LT,        UC_LT,

        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_ALPH,      UC_ALPH,      UC_ALPH,      UC_ALPH,     UC_ALPH,     UC_OFF,
        UC_ALPH,      UC_HMOD,      UC_HMOD,      UC_HMOD,     UC_HMOD,     UC_OFF,
        UC_ALPH,      UC_ALPH,      UC_SYM,       UC_SYM,      UC_LT,       UC_OFF,
        UC_LT,        UC_LT,
    },
    [U_SYM] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_SYM,       UC_SYM,       UC_SYM,      UC_SYM,      UC_SYM,
        UC_OFF,       UC_SYM,       UC_SYM,       UC_SYM,      UC_SYM,      UC_SYM,
        UC_OFF,       UC_SYM,       UC_SYM,       UC_SYM,      UC_SYM,      UC_SYM,
        UC_SYM,       UC_SYM,
        ...
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_MOD,       UC_MOD,       UC_MOD,      UC_MOD,      UC_OFF,
        UC_OFF,       UC_OFF,       UC_OFF,       UC_MOD,      UC_OFF,      UC_OFF,
        UC_LTD,       UC_OFF,
    },
    [U_NUM] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_SYM,       UC_NUM,       UC_NUM,      UC_NUM,      UC_SYM,
        UC_OFF,       UC_SYM,       UC_NUM,       UC_NUM,      UC_NUM,      UC_SYM,
        UC_OFF,       UC_SYM,       UC_NUM,       UC_NUM,      UC_NUM,      UC_SYM,
        UC_NUM,       UC_SYM,
    ...
    [U_NAV] = {
        ...
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_MOD,       UC_MOD,       UC_MOD,      UC_MOD,      UC_OFF,
        UC_OFF,       UC_OFF,       UC_MOD,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_LTD,       UC_OFF,

        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_BTN,       UC_BTN,       UC_BTN,       UC_BTN,      UC_BTN,      UC_OFF,
        UC_ARRW,      UC_ARRW,      UC_ARRW,      UC_ARRW,     UC_BTN,      UC_OFF,
        UC_NAV,       UC_NAV,       UC_NAV,       UC_NAV,      UC_NAV,      UC_OFF,
        UC_BTN,       UC_BTN,
    },
    [U_MOUSE] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        ...
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_BTN,       UC_BTN,       UC_BTN,       UC_BTN,      UC_BTN,      UC_OFF,
        UC_MUSE,      UC_MUSE,      UC_MUSE,      UC_MUSE,     UC_OFF,      UC_OFF,
        UC_MUSE,      UC_MUSE,      UC_MUSE,      UC_MUSE,     UC_MUSE,     UC_OFF,
        UC_BTN,       UC_BTN,
    },
    [U_MEDIA] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        ...
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_BTN,       UC_BTN,       UC_BTN,       UC_BTN,      UC_BTN,      UC_OFF,
        UC_MEDA,      UC_MEDA,      UC_MEDA,      UC_MEDA,     UC_OFF,      UC_OFF,
        UC_MUSE,      UC_MUSE,      UC_MUSE,      UC_MUSE,     UC_BTN,      UC_OFF,
        UC_MEDA,      UC_MEDA,
    },
    [U_FUN] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_FUN,       UC_FUN,       UC_FUN,      UC_FUN,      UC_FUN,
        UC_OFF,       UC_FUN,       UC_FUN,       UC_FUN,      UC_FUN,      UC_FUN,
        UC_OFF,       UC_FUN,       UC_FUN,       UC_FUN,      UC_FUN,      UC_FUN,
        UC_BTN,       UC_BTN,
    ...
    [U_BUTTON] = {
        UC_OFF,       UC_OFF,       UC_OFF,       UC_OFF,      UC_OFF,      UC_OFF,
        UC_OFF,       UC_BTN,       UC_BTN,       UC_BTN,      UC_BTN,      UC_BTN,
        UC_OFF,       UC_MOD,       UC_MOD,       UC_MOD,      UC_MOD,      UC_OFF,
        UC_OFF,       UC_BTN,       UC_BTN,       UC_BTN,      UC_BTN,      UC_BTN,
        UC_MUSE,      UC_MUSE,
